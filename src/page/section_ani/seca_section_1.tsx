...
export default function Seca_section_1() {
	return (
		<section className="mt-12 pt-12">
			<Layout_row_title_desrcription>
				...
				<div className="watch mb-4">
					<h2 className="main font-heading absolute  mt-3 text-4xl font-bold" >
						We Provide Best <br />
						<span className="text-blue-500">Web design </span>services
					</h2>
					<p className="sub text-blueGray-400 absolute  mb-6 leading-loose" >
