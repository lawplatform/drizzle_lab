...
export default function C_guide({ children, title, des }: C_guide_prop) {
	return (
		<div
			className="flex h-80 flex-col items-center justify-center gap-2 rounded-md border-2 border-dashed border-gray-300/50 p-4 hover:bg-zinc-100 dark:text-gray-200">
